...
public class LinkedList {
    ...
    public static void main(String[] args) {
        ...
        // Deletion by key
        // Delete node with value 1 (at head)
        deleteByKey(list, 1);
        printList(list);

        // Delete node with value 4 (in the middle)
        deleteByKey(list, 4);
        printList(list);
        ...
        // Delete node at position 0 (at head)
        deleteAtPosition(list, 0);
        printList(list);

        // Delete node at position 2 (in the middle)
        deleteAtPosition(list, 2);
        printList(list);

        // Delete node at position 10 (not present)
